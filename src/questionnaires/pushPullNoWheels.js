...
const generateClinicalReport = ({ caseId, answers, resultQuestion, allQuestions }) => {
  ...
  let report = `INFORME DE EVALUACIÓN DE RIESGO - EMPUJE Y TRACCIÓN (SIN RUEDAS)\n`;
  report += `==================================================\n\n`;
...
const questions = [
  ...
  // --- Resultados ---
  { id: "result_alto_sin_ruedas", text: "Riesgo Alto: La combinación de peso, acción y factores de riesgo supera los límites recomendados.", type: "result", color: "red" },
  { id: "result_bajo_sin_ruedas", text: "Riesgo Bajo: La tarea se encuentra dentro de los límites aceptables.", type: "result", color: "green" },
];
