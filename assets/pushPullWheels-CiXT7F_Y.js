import{d as u}from"./commonAnamnesis-DnXU8SF6.js";import{c as p}from"./commonDemographics-Nu-SUVbe.js";const _=({caseId:s,answers:o,resultQuestion:r,allQuestions:n})=>{if(!r)return"Generando informe...";const l=(d,a)=>{const t=n.find(i=>i.id===d);return!t||!t.options?a:Array.isArray(a)?a.map(i=>t.options.find(c=>c.value===i)?.label||i).join(", "):t.options.find(i=>i.value===a)?.label||a};let e=`INFORME DE EVALUACIÓN CALCULADORA LUMBAGO - EMPUJE Y TRACCIÓN (CON RUEDAS)
`;return e+=`==================================================
