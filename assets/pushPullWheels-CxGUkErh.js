import{d as c}from"./commonAnamnesis-DdwxIT9E.js";const _=({caseId:s,answers:a,resultQuestion:o,allQuestions:t})=>{if(!o)return"Generando informe...";const l=(d,i)=>{const n=t.find(r=>r.id===d);return!n||!n.options?i:Array.isArray(i)?i.map(r=>n.options.find(u=>u.value===r)?.label||r).join(", "):n.options.find(r=>r.value===i)?.label||i};let e=`INFORME DE EVALUACIÓN DE RIESGO - EMPUJE Y TRACCIÓN (CON RUEDAS)
`;return e+=`==================================================
