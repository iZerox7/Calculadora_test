import{d as _}from"./commonAnamnesis-DdwxIT9E.js";const c=({caseId:s,answers:a,resultQuestion:r,allQuestions:i})=>{if(!r)return"Generando informe...";const n=(u,t)=>{const l=i.find(o=>o.id===u);return!l||!l.options?t:Array.isArray(t)?t.map(o=>l.options.find(d=>d.value===o)?.label||o).join(", "):l.options.find(o=>o.value===t)?.label||t};let e=`INFORME DE EVALUACIÓN CALCULADORA LUMBAGO - EMPUJE Y TRACCIÓN (SIN RUEDAS)
`;return e+=`==================================================
