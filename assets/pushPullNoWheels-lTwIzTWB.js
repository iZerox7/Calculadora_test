import{d as u}from"./commonAnamnesis-DnXU8SF6.js";import{c as _}from"./commonDemographics-Nu-SUVbe.js";const p=({caseId:s,answers:o,resultQuestion:r,allQuestions:n})=>{if(!r)return"Generando informe...";const l=(c,a)=>{const i=n.find(t=>t.id===c);return!i||!i.options?a:Array.isArray(a)?a.map(t=>i.options.find(d=>d.value===t)?.label||t).join(", "):i.options.find(t=>t.value===a)?.label||a};let e=`INFORME DE EVALUACIÓN CALCULADORA LUMBAGO - EMPUJE Y TRACCIÓN (SIN RUEDAS)
`;return e+=`==================================================
...
`,e+=`- ${r.text}
`,e},g={prot_lumbago_alto:{titulo:"PROTOCOLO MANEJO - RIESGO ALTO",pasos:["1. REPOSO: Reposo laboral según intensidad del dolor (48-72h).","2. TRATAMIENTO: Analgesia reglada y calor local.","3. RESTRICCIÓN: Prohibición absoluta de levantamiento/tracción de cargas.","4. EVALUACIÓN: Derivación a Kinesioterapia.","5. SEGUIMIENTO: Control médico en 7 días."]},prot_lumbago_bajo:{titulo:"PROTOCOLO MANEJO - RIESGO BAJO",pasos:["1. REPOSO RELATIVO: Mantenerse activo.","2. CALOR LOCAL: Aplicar calor por 20 min, 3 veces al día.","3. EDUCACIÓN: Reinstruir en técnicas de empuje/tracción.","4. MEDICACIÓN: SOS en caso de dolor.","5. REINTEGRO: Continuar labores con precaución."]}},m=(s,o=!1)=>{const r=s.tipo_empuje_sin_ruedas,n=parseFloat(s.peso_carga_sin_ruedas),l=s.factores_riesgo_sin_ruedas||[],e={id:"result_alto_sin_ruedas",text:"Riesgo Alto",color:"red",protocolId:"prot_lumbago_alto"},c={id:"result_bajo_sin_ruedas",text:"Riesgo Bajo",color:"green",protocolId:"prot_lumbago_bajo"};if(r==="rodado"&&n>400||r==="pivoteo"&&n>80||r==="arrastrar"&&n>25)return e;if(!o)return null;let a=0;return l.forEach(i=>{switch(i){case"obstaculos":a+=1;break;case"sin_manillas":a+=1;break;case"piso_malo":a+=2;break;case"carga_inestable":a+=1;break;case"obstruye_vision":a+=1;break;case"carga_peligrosa":a+=1;break;case"distancia_2_10":a+=1;break;case"distancia_mas_10":a+=2;break}}),a>=2?e:c},b=[..._,{id:"tipo_empuje_sin_ruedas",text:"Tipo de empuje / tracción",type:"options",group:"risk",options:[{value:"rodado",label:"Rodado"},{value:"pivoteo",label:"Pivoteo y rodado"},{value:"arrastrar",label:"Arrastrar / Halar / Deslizar"}]},{id:"peso_carga_sin_ruedas",text:"¿Cuál es el peso de la carga? (kg)",type:"number",group:"risk",placeholder:"Ej: 50"},{id:"factores_riesgo_sin_ruedas",text:"Factores de riesgo adicionales (Puedes seleccionar más de una opción)",type:"multi",group:"risk",options:[{value:"obstaculos",label:"Existen obstáculos o escalones (+1)"},{value:"sin_manillas",label:"Sin manillas / Contacto incómodo (+1)"},{value:"piso_malo",label:"Superficie de piso en mal estado (+2)"},{value:"carga_inestable",label:"Carga inestable (+1)"},{value:"obstruye_vision",label:"Carga obstruye la visión (+1)"},{value:"carga_peligrosa",label:"Carga peligrosa al tacto (+1)"},{value:"distancia_2_10",label:"Distancia 2-10 metros (+1)"},{value:"distancia_mas_10",label:"Distancia > 10 metros (+2)"},{value:"ninguno",label:"Sin Factores de Riesgo"}]},...u,{id:"result_alto_sin_ruedas",text:"Riesgo Alto",type:"result",color:"red"},{id:"result_bajo_sin_ruedas",text:"Riesgo Bajo",type:"result",color:"green"}],E={questions:b,generateClinicalReport:p,evaluateRisk:m,protocols:g,guideImage:"Memoria_ruedant.png"};export{E as default};
